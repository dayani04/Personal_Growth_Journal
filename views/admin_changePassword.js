...
router.get('/', (req, res) => {
    res.send(`
        ...
        <nav>
            ...
            <a href="/admin_profile" style="color: #7B97D3; margin: 0 15px; text-decoration: none; font-size: 1.1em;">Back</a>
        </nav>
        ...
        <div class="container">
            ${req.session.verificationCode ? `
                ...
                <form action="/admin_changePassword/verify" method="POST">
...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        if (!user) {
            ...
            return res.redirect('/admin_changePassword');
        }
        ...
        res.redirect('/admin_changePassword');
    } catch (err) {
